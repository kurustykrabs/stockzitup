...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "stockzitup_production"
  ...
  config.action_mailer.default_url_options = { :host => 'https://whispering-atoll-46703.herokuapp.com/' }

  Rails.application.routes.default_url_options[:host] = 'https://whispering-atoll-46703.herokuapp.com/'
